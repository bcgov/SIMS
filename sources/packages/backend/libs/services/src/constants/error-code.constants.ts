...
export const STUDENT_LOAN_BALANCE_DUPLICATE_RECORD =
  "STUDENT_LOAN_BALANCE_DUPLICATE_RECORD";
export const STUDENT_LOAN_BALANCE_INVALID_FILE_HEADER =
  "STUDENT_LOAN_BALANCE_INVALID_FILE_HEADER";
export const STUDENT_LOAN_BALANCE_INVALID_FILE_FOOTER =
  "STUDENT_LOAN_BALANCE_INVALID_FILE_FOOTER";
export const STUDENT_LOAN_BALANCE_RECORDS_MISMATCH =
