  ...
  () => {
    ...
    it("Should generate an MSFAA part-time file and update the dateRequested when there are pending MSFAA records.", async () => {
      ...
      expect(msfaaPartTimeMarried).toBe(
        `2000000001000900000000PABCD19950630${processDateFormatted}Doe                      John              MMAddress Line 1                          Address Line 2                          Calgary                  AB  H1H 1H1         CAN                 1111111111          john.doe@somedomain.com                                                                                                                                                                                                                    PT                                                                                                              `,
      );
      ...
      expect(msfaaPartTimeRelationshipOther).toBe(
        `2000000001002900000002PIHKL20011231${processDateFormatted}Other Doe                Other John        FOAddress Line 1                          Address Line 2                          Victoria                 BC  H1H 1H1         CAN                 99999999999999999999jane.doe@someotherdomain.com                                                                                                                                                                                                               PT                                                                                                              `,
      );
