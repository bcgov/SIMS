  ...
  () => {
    ...
    it("Should generate an MSFAA part-time file and update the dateRequested when there are pending MSFAA records.", async () => {
      ...
      expect(msfaaPartTimeOtherCountry).toBe(
        `2000000001001900000001PEFDG20000101${processDateFormatted}Other Doe                Jane              XSAddress Line 1                                                                  Some city on United State                    United States       00000000000000000049jane.doe@somedomain.com                                                                                                                                                                                                                    PT                                                                                                              `,
      );
