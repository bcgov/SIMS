  ...
  () => {
    ...
    it("Should generate an MSFAA part-time file and update the dateRequested when there are pending MSFAA records.", async () => {
      ...
      expect(msfaaPartTimeMarried).toBe(
        `2000000001000900000000PABCD19950630${processDateFormatted}Doe AAAAAAC              John EEEEIIII     MMNOOOOO Address Line 1                   UUUUs Address Line 2                    Calgary                  AB  H1H 1H1         Canada              00000000001111111111john.doe@somedomain.com                                                                                                                                                                                                                    PT                                                                                                              `,
      );
