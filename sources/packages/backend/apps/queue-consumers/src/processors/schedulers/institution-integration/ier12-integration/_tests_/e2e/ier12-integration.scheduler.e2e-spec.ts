...
describe(describeProcessorRootTest(QueueNames.IER12Integration), () => {
  ...
  it("Should generate IER12 record for only the disbursement in the default IER generation range but the application award totals must be the sum of the awards from both the disbursements of the current assessment of the application.", async () => {
    // Arrange
