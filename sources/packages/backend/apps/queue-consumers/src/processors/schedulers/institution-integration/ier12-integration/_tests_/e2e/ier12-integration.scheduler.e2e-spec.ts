...
describe(describeProcessorRootTest(QueueNames.IER12Integration), () => {
  ...
  /**
   * An old date to fall outside the default IER file generation range.
   */
  const dateOutsideDefaultIERFileGenerationRange = new Date("2024-01-01");
  /**
