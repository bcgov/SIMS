...
SET
    report_sql = (
        ...
        SELECT
            ...
            TO_CHAR(
                (
                    assessment.assessment_date AT TIME ZONE 'America/Vancouver'
                ),
            ...
            offering.study_breaks ->> 'totalFundedWeeks' AS "Number of Funded Weeks",
            disbursement.coe_status AS "COE Status",
            TO_CHAR(
                (
                    disbursement.coe_updated_at AT TIME ZONE 'America/Vancouver'
                ),
                'YYYY-MM-DD HH24:MI:SS'
            ) AS "COE Actioned",
