...
ALTER COLUMN
    program_id DROP NOT NULL;

-- Remove the and re-create existing unique index which was based on program_id and location_id being non-nullable
-- and treat null as a value for uniqueness.
