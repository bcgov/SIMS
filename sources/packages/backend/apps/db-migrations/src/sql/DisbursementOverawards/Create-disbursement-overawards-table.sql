...
-- ## Comments
COMMENT ON TABLE sims.disbursement_overawards IS 'Student overawards resulted from reassessments calculations.';
...
COMMENT ON COLUMN sims.disbursement_overawards.overaward_value IS 'Overaward value. A positive value indicates the amount that the student owes.';
