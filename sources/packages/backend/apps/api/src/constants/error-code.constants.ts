...
export const STUDENT_HAS_PENDING_APPEAL = "STUDENT_HAS_PENDING_APPEAL";
...
export const ACTIVE_INSTITUTION_RESTRICTION = "ACTIVE_INSTITUTION_RESTRICTION";
...
/**
 * Student application is in invalid state for application restriction bypass removal.
 */
export const APPLICATION_IN_INVALID_STATE_FOR_APPLICATION_RESTRICTION_BYPASS_REMOVAL =
...
/**
 * No location selected for designation.
 */
