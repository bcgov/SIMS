...
@Injectable()
export class FormSubmissionUpdateModifiedIndependentOnDecisionAction extends FormSubmissionAction {
  /**
   * Type of action being performed.
   */
  get actionType(): FormSubmissionActionType {
    return FormSubmissionActionType.UpdateModifiedIndependentOnDecision;
  }
