      ...
      >
        <v-expansion-panels>
          ...
          >
            <v-expansion-panel-text
              ><p>
                Using the BC Services Card account is the easiest, most secure
                way to apply for student financial aid. However, we understand
                not everyone is eligible for the BC Services Card account.
                Please follow the steps below to inquire about alternate login
                options.
              </p>
              <p>
