<template>
  <v-container class="container-max-width mx-auto mt-10">
    ...
    <v-card elevation="2" class="mb-6">
      <v-card-text>
        <h1 class="category-header-large primary-color mb-6">For Students</h1>
    ...
    <v-card elevation="2">
      <v-card-text>
        <h1 class="category-header-large primary-color mb-6">
          For Institutions
        </h1>
        ...
        <v-row align="center">
          ...
          <v-col cols="12" md="7">
            ...
            <p class="mb-4">
              Create and manage your institution account using your Business or
              Basic BCeID User ID.
            </p>
