...
export const MINIMUM_IDLE_TIME_FOR_WARNING_STUDENT = 270;
// * MINIMUM_IDLE_TIME_FOR_WARNING_STUDENT in seconds i,e 270 seconds is 4.5 minutes
export const MINIMUM_IDLE_TIME_FOR_WARNING_INSTITUTION = 270;
// * MINIMUM_IDLE_TIME_FOR_WARNING_STUDENT in seconds i,e 270 seconds is 4.5 minutes
export const MINIMUM_IDLE_TIME_FOR_WARNING_SUPPORTING_USER = 270;
// * MINIMUM_IDLE_TIME_FOR_WARNING_STUDENT in seconds i,e 270 seconds is 4.5 minutes
