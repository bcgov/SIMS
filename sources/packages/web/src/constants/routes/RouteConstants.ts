...
export const StudentRoutesConst = {
  ...
  REPORT_PARTNER_INFORMATION: Symbol(),
  CHANGE_REQUEST_REPORT_PARTNER_INFORMATION: Symbol(),
  ...
  STUDENT_FORMS_SUBMISSION_VIEW_FROM_APPLICATION_SUMMARY: Symbol(),
  STUDENT_FORMS_SUBMISSION_VIEW_FROM_HISTORY: Symbol(),
};
...
export const InstitutionRoutesConst = {
  ...
  STUDENT_FORM_SUBMISSION_HISTORY: Symbol(),
  STUDENT_APPLICATION_DETAILS: Symbol(),
...
export const AESTRoutesConst = {
  ...
  STUDENT_DETAILS: Symbol(),
  STUDENT_PROFILE: Symbol(),
  STUDENT_DISABILITY_PROFILE: Symbol(),
  STUDENT_DISABILITY_PROFILE_DISABILITY_EDIT: Symbol(),
  STUDENT_DISABILITY_PROFILE_DISABILITY_DRAFT: Symbol(),
  STUDENT_DISABILITY_PROFILE_DISABILITY_VIEW: Symbol(),
  STUDENT_APPLICATIONS: Symbol(),
  ...
  SCHOLASTIC_STANDING_VIEW: Symbol(),
  SCHOLASTIC_STANDING_VIEW_FROM_RESTRICTIONS: Symbol(),
  ...
  STUDENT_APPLICATION_FORM_SUBMISSION_APPROVAL: Symbol(),
  FORM_SUBMISSION_APPROVAL_FROM_HISTORY: Symbol(),
  FORM_SUBMISSION_APPROVAL_FROM_PENDING_APPEALS: Symbol(),
  FORM_SUBMISSION_APPROVAL_FROM_PENDING_FORMS: Symbol(),
  STUDENT_APPLICATION_FORM_SUBMISSION_APPROVAL_VERSION: Symbol(),
  STUDENT_APPLICATION_OFFERING_CHANGE_REQUEST: Symbol(),
  STUDENT_APPLICATION_OFFERING_CHANGE_REQUEST_VERSION: Symbol(),
  NOTICE_OF_ASSESSMENT_VIEW: Symbol(),
  NOTICE_OF_ASSESSMENT_VIEW_VERSION: Symbol(),
  REPORTS: Symbol(),
  BATCH_REASSESSMENT: Symbol(),
  ...
  LEGACY_STUDENT_APPEALS: Symbol(),
  STUDENT_FORM_SUBMISSION_PENDING_FORMS: Symbol(),
  STUDENT_FORM_SUBMISSION_PENDING_APPEALS: Symbol(),
  STUDENT_FORM_SUBMISSION_HISTORY: Symbol(),
