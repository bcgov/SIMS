<template>
  <modal-dialog-base :showDialog="showDialog" title="StudentAid BC Declaration">
    <template #content>
      <p>
      ...
      <content-group-info class="div-scroll"
        ...
        ><v-list class="list-color mb-5">
          ...
          <v-list-item>
            2. The student's school will have access to information provided in
            this appendix;
          </v-list-item>
          <v-list-item>
        ...
        <v-row
          ><v-col
            ...
            collected and managed in accordance with sections 26(c) and 26(e) of
            the Freedom of Information and Protection of Privacy Act, R.S.B.C.
            1996, c. 165, and under the authority of the Canada Student
            Financial Assistance Act, R.S.C. 1994, Chapter C-28 and StudentAid
            BC. The information provided will be used to determine eligibility
            for a benefit through</v-col
          ></v-row
        > </content-group-info
      ><v-checkbox
