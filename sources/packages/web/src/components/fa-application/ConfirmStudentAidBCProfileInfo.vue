  ...
  <div class="confirm-info-panel">
    ...
    <div class="p-fluid  p-grid p-extra" >
        <div class="p-field p-col-4">
          ...
          <div class="p-col text-extra">{{ studentConfirmInfo.firstName }} {{ studentConfirmInfo.lastName }}</div>
        </div>
    </div>
    <div class="p-fluid  p-grid " >
      <div class="p-field p-col-4">
        <label for="dateOfBirth" class="label-extra">Date of Birth</label>
        <div class="p-col text-extra">{{ studentConfirmInfo.birthDateFormatted }}</div>
      </div>
      <div class="p-field p-col-4">
    ...
    <div class="p-fluid p-formgrid p-grid">
      <div class="p-field p-col-4">
        ...
        <div class="p-field p-col text-extra">{{ studentConfirmInfo.addressLine1 }},<br/>{{ studentConfirmInfo.addressLine2 }}<br/>{{ studentConfirmInfo.city }} {{ studentConfirmInfo.provinceState }} {{ studentConfirmInfo.postalCode }}<br/>{{ studentConfirmInfo.country }}<br/></div>
      </div>
      <div class="p-field p-col-6">
          <label for="phone" class="label-extra">Phone Number</label>
          <div class="p-field p-col text-extra">{{ studentConfirmInfo.phoneNumber }}</div>
      </div>      
    </div>
