  ...
  setup(props: any) {
    ...
    const prepareContent = () => {
      ...
      if (
        ...
        infoHeader.value = `This application requires confirmation of enrollment so funding can
          be dispersed`;
        infoHeaderClass.value = "";
      ...
      if (COEStatus.declined === props.data.applicationCOEStatus) {
        ...
        infoHeader.value = `This confirmation of enrollment has been declined`;
        infoHeaderClass.value = "";
