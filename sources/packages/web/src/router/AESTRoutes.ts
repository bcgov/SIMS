...
export const aestRoutes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      {
        path: AppRoutes.LegacyChangeRequests,
        name: AESTRoutesConst.LEGACY_CHANGE_REQUESTS,
        components: {
          default: LegacyChangeRequests,
          sidebar: AESTHomeSideBar,
        },
        meta: {
          clientType: ClientIdType.AEST,
      ...
      {
        path: AppRoutes.PendingForms,
        name: AESTRoutesConst.PENDING_FORMS,
        components: {
          default: PendingForms,
          sidebar: AESTHomeSideBar,
        },
        meta: {
          clientType: ClientIdType.AEST,
      ...
      {
        path: AppRoutes.ApplicationChangeRequests,
        name: AESTRoutesConst.APPLICATION_CHANGE_REQUESTS_PENDING,
        components: {
          default: ApplicationChangeRequests,
          sidebar: AESTHomeSideBar,
        },
        meta: {
          clientType: ClientIdType.AEST,
      ...
      {
        path: AppRoutes.PendingPrograms,
        name: AESTRoutesConst.PENDING_PROGRAMS,
        components: {
          default: ViewPendingPrograms,
          sidebar: AESTHomeSideBar,
        },
        meta: {
          clientType: ClientIdType.AEST,
