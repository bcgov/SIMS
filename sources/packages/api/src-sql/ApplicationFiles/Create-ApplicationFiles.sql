...
COMMENT ON COLUMN application_files.group_name IS 'Allow to group the files that belongs to a certain context.';
COMMENT ON COLUMN application_files.mime_type IS 'File MIME type.';
