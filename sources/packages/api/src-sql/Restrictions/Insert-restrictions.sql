...
VALUES
  (
    ...
    'BCSL Delinquency',
    ARRAY ['Stop BC funding'] :: sims.restriction_action_type [],
    'Error'
  );
...
VALUES
  (
    ...
    'Death.',
    'Federal',
    ARRAY ['Stop apply', 'Stop disbursement'] :: sims.restriction_action_type [],
    'Error'
  );
...
--     'Academic',
--     ARRAY ['Stop full time'] :: sims.restriction_action_type [],
--     'Error'
--   );
INSERT INTO
  sims.restrictions(
