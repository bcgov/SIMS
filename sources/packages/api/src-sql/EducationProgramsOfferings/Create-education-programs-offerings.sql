CREATE TABLE IF NOT EXISTS education_programs_offerings(
  ...
  lacks_program_dates BIT NOT NULL,
  lacks_study_breaks BIT NOT NULL,
  lacks_fixed_costs BIT NOT NULL,
  tution_remittance_requested VARCHAR(50) NOT NULL,
...
-- ## Comments
COMMENT ON TABLE education_programs_offerings IS '';
...
COMMENT ON COLUMN education_programs_offerings.actual_tution_costs IS 'Offering Actual Tution Costs';
...
COMMENT ON COLUMN education_programs_offerings.amount_requested IS 'Offering Amount Requested';
...
COMMENT ON COLUMN education_programs_offerings.lacks_program_dates IS 'Offering does not have Program Dates?';
...
COMMENT ON COLUMN education_programs_offerings.tution_remittance_requested IS 'Offering Tution Remittance Requested like Yes, No';
