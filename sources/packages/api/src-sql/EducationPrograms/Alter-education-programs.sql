...
--Changing the data type of has_minimun_age as it is one of entrance requirement now.
ALTER TABLE
    sims.education_programs
ALTER COLUMN
...
COMMENT ON COLUMN sims.education_programs.min_hours_week_avi IS 'This column determins if an aviation program satisfies minimum hours per week';
...
COMMENT ON COLUMN sims.education_programs.min_high_school IS 'This column respresents the entrance requirement of minimum grade 12 or equivalent';
...
COMMENT ON COLUMN sims.education_programs.requirements_by_institution IS 'This column respresents the entrance requirement established by the institution that enable completion of the program study.';
...
COMMENT ON COLUMN sims.education_programs.requirements_by_bcita IS 'This column respresents the entrance requirement set by B.C. ITA.';
