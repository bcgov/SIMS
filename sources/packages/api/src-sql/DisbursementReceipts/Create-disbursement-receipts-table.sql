...
CREATE TABLE IF NOT EXISTS sims.disbursement_receipts(
    ...
    total_entitled_disbursed_amount NUMERIC(5) NOT NULL,
    total_disbursed_amount NUMERIC(5) NOT NULL,
    disburse_date DATE NOT NULL,
    disburse_amount_student NUMERIC(5) NOT NULL,
    disburse_amount_institution NUMERIC(5) NOT NULL,
