...
-- Create reference between applications and student_assessments without delete cascade. --
ALTER TABLE
    sims.applications
ADD
    CONSTRAINT applications_current_assessment_id_fkey FOREIGN KEY(current_assessment_id) REFERENCES sims.student_assessments(id);
...
-- Create reference between application_exception_requests and application_exceptions without delete cascade. --
ALTER TABLE
    sims.application_exception_requests
ADD
    CONSTRAINT application_exception_requests_application_exception_id_fkey FOREIGN KEY(application_exception_id) REFERENCES sims.application_exceptions(id);
...
-- Create reference between student_assessments and applications without delete cascade. --
ALTER TABLE
    sims.student_assessments
ADD
    CONSTRAINT student_assessments_application_id_fkey FOREIGN KEY(application_id) REFERENCES sims.applications(id);
...
-- Create reference between applications and students without delete cascade. --
ALTER TABLE
    sims.applications
ADD
    CONSTRAINT applications_student_id_fkey FOREIGN KEY(student_id) REFERENCES sims.students(id);
...
-- Create reference between application_student_files and applications without delete cascade.--
ALTER TABLE
    sims.application_student_files
ADD
    CONSTRAINT application_student_files_application_id_fkey FOREIGN KEY(application_id) REFERENCES sims.applications(id);
...
-- Create reference between application_student_files and student_files without delete cascade.--
ALTER TABLE
    sims.application_student_files
ADD
    CONSTRAINT application_student_files_student_file_id_fkey FOREIGN KEY(student_file_id) REFERENCES sims.student_files(id);
...
-- Create reference between cra_income_verifications and supporting_users without delete cascade. --
ALTER TABLE
...
-- Create reference between cra_income_verifications and applications without delete cascade. --
ALTER TABLE
    sims.cra_income_verifications
ADD
...
-- Create reference between designation_agreements and institutions without delete cascade. --
ALTER TABLE
...
-- Create reference between designation_agreement_locations and designation_agreements without delete cascade.--
ALTER TABLE
...
-- Create reference between designation_agreement_locations and institution_locations without delete cascade.--
ALTER TABLE
    sims.designation_agreement_locations
ADD
...
-- Create reference between disbursement_feedback_errors and disbursement_schedules without delete cascade. --
ALTER TABLE
...
-- Create reference between disbursement_schedules and student_assessments without delete cascade. --
ALTER TABLE
    sims.disbursement_schedules
ADD
    CONSTRAINT disbursement_schedules_student_assessment_id_fkey FOREIGN KEY(student_assessment_id) REFERENCES sims.student_assessments(id);
...
-- Create reference between disbursement_values and disbursement_schedules without delete cascade. --
ALTER TABLE
    sims.disbursement_values
ADD
    CONSTRAINT disbursement_values_disbursement_schedule_id_fkey FOREIGN KEY(disbursement_schedule_id) REFERENCES sims.disbursement_schedules(id);
...
-- Create reference between education_programs and institutions without delete cascade.--
ALTER TABLE
    sims.education_programs
ADD
    CONSTRAINT education_programs_institution_id_fkey FOREIGN KEY(institution_id) REFERENCES sims.institutions(id);
...
-- Create reference between education_programs_offerings and education_programs without delete cascade.--
ALTER TABLE
    sims.education_programs_offerings
ADD
    CONSTRAINT education_programs_offerings_program_id_fkey FOREIGN KEY(program_id) REFERENCES sims.education_programs(id);
...
-- Create reference between education_programs_offerings and institution_locations without delete cascade. --
ALTER TABLE
    sims.education_programs_offerings
ADD
    CONSTRAINT education_programs_offerings_location_id_fkey FOREIGN KEY(location_id) REFERENCES sims.institution_locations(id);
...
-- Create reference between institution_users and users without delete cascade.--
ALTER TABLE
...
-- Create reference between institution_user_auth and institution_users without delete cascade. --
ALTER TABLE
...
-- Create reference between institution_user_auth and institution_locations without delete cascade.--
ALTER TABLE
    sims.institution_user_auth
ADD
...
-- Create reference between institution_user_auth and institution_user_type_roles without delete cascade.--
ALTER TABLE
    sims.institution_user_auth
ADD
...
-- Create reference between institution_locations and institutions without delete cascade.--
ALTER TABLE
    sims.institution_locations
ADD
    CONSTRAINT institution_locations_institution_id_fkey FOREIGN KEY(institution_id) REFERENCES sims.institutions(id);
...
-- Create reference between institution_users and institutions without delete cascade.--
ALTER TABLE
    sims.institution_users
ADD
...
-- Create reference between msfaa_numbers and students without delete cascade. --
ALTER TABLE
    sims.msfaa_numbers
ADD
    CONSTRAINT msfaa_numbers_student_id_fkey FOREIGN KEY(student_id) REFERENCES sims.students(id);
...
-- Create reference between sin_validations and users without delete cascade. --
ALTER TABLE
    sims.sin_validations
ADD
    CONSTRAINT sin_validations_user_id_fkey FOREIGN KEY(user_id) REFERENCES sims.users(id);

-- Delete reference between students and users. --
ALTER TABLE
    sims.students DROP CONSTRAINT IF EXISTS students_user_id_fkey;

-- Create reference between students and users without delete cascade.--
ALTER TABLE
    sims.students
ADD
    CONSTRAINT students_user_id_fkey FOREIGN KEY(user_id) REFERENCES sims.users(id);
...
-- Create reference between student_appeal_requests and student_appeals without delete cascade.--
ALTER TABLE
    sims.student_appeal_requests
ADD
    CONSTRAINT student_appeal_requests_student_appeal_id_fkey FOREIGN KEY(student_appeal_id) REFERENCES sims.student_appeals(id);
...
-- Create reference between student_appeals and applications without delete cascade. --
ALTER TABLE
    sims.student_appeals
ADD
    CONSTRAINT student_appeals_application_id_fkey FOREIGN KEY(application_id) REFERENCES sims.applications(id);
...
-- Create reference between student_assessments and education_programs_offerings without delete cascade.--
ALTER TABLE
    sims.student_assessments
ADD
    CONSTRAINT student_assessments_offering_id_fkey FOREIGN KEY(offering_id) REFERENCES sims.education_programs_offerings(id);
...
-- Create reference between student_assessments and student_appeals without delete cascade. --
ALTER TABLE
    sims.student_assessments
ADD
    CONSTRAINT student_assessments_student_appeal_id_fkey FOREIGN KEY(student_appeal_id) REFERENCES sims.student_appeals(id);
...
-- Create reference between student_assessments and student_scholastic_standings without delete cascade.--
ALTER TABLE
    sims.student_assessments
ADD
    CONSTRAINT student_assessments_student_scholastic_standing_id_fkey FOREIGN KEY(student_scholastic_standing_id) REFERENCES sims.student_scholastic_standings(id);
...
-- Create reference between student_files and students without delete cascade. --
ALTER TABLE
    sims.student_files
ADD
    CONSTRAINT student_files_student_id_fkey FOREIGN KEY(student_id) REFERENCES sims.students(id);
...
-- Create reference between student_scholastic_standings and applications without delete cascade.--
ALTER TABLE
    sims.student_scholastic_standings
ADD
    CONSTRAINT student_scholastic_standings_application_id_fkey FOREIGN KEY(application_id) REFERENCES sims.applications(id);
...
-- Create reference between supporting_users and users without delete cascade. --
ALTER TABLE
    sims.supporting_users
ADD
    CONSTRAINT supporting_users_user_id_fkey FOREIGN KEY(user_id) REFERENCES sims.users(id);
...
-- Create reference between supporting_users and applications without delete cascade.--
ALTER TABLE
    sims.supporting_users
ADD
    CONSTRAINT supporting_users_application_id_fkey FOREIGN KEY(application_id) REFERENCES sims.applications(id);