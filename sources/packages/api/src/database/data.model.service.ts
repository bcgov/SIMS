...
export class DataModelService <DataModel extends BaseModel> {
  ...
  static getRepo<DataModel>(connection: Connection, entity: Function): Repository<DataModel> {
...
export class RecordDataModelService <DataModel extends RecordDataModel> extends DataModelService<DataModel> {}