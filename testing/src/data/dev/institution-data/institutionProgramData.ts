export enum programData {
  ...
  programDescription = "International Exchange Programs offer students the opportunity to experience student life at one of USM’s partner universities around the world. Students pay Southern Miss in-state tuition and fees and receive the same benefits as a university student at the partner institution. Exchange programs are one to two semesters and earn up to 18 USM credit hours per semester. Visit the tabs above to explore which partner university will be the best fit for you!",
